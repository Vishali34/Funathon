...
<html lang='en'>
  ...
  <body>
    <main>
      <nav class='navBar'>
        <h1>Mataparthi vishali Portfolio</h1>
      ...
      <section class='heroSection'>
        ...
        <h1>Mataparthi vishali</h1>
        <h3>Computer Science Engineering</h3>
        </div>
      </section>
      <section class='aboutMe' id='aboutMe'>
        <h1>What I Do...</h1>
        <p> <b>Hi I am Vishali  b.tech 2nd year from KL University Hyderabad</b>. I created this website for my Profile.
